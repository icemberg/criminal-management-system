...
<html>
    ...
    if (isset($_POST['s'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query = "SELECT p_id, p_pass FROM police WHERE p_id='$name' AND p_pass='$pass'";
    ...
    ?>
     ...
     <body
          style="color: black; background-image: url(locker.jpeg); background-size: 100%; background-repeat: no-repeat;">
